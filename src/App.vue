...
const projects = [
  ...
  },
  {
    ...
    description: "A Vue.js web app to track significant Hong Kong dates, including Lunar New Year and public holidays. Features real-time countdowns and a responsive, user-friendly interface.",
